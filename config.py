...
# Background bulk email sending settings
BULK_EMAIL_SEND_DELAY_SEC = _env_float("BULK_EMAIL_SEND_DELAY_SEC", 2.0)
BULK_EMAIL_MAX_ATTEMPTS = _env_int("BULK_EMAIL_MAX_ATTEMPTS", 2)
